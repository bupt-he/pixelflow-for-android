...
import processing.dw.DwFluid2D;
...
//    System.out.println("ParticelSystem: size = "+particles_x+"/"+particles_y +" ("+particles_x*particles_y+" objects)");
    ...
    String dir = DwPixelFlow.SHADER_DIR+"";
    ...
    // allocate texture
    tex_particles.resize(context, GLES30.GL_RGBA32F, particles_x, particles_y, GLES30.GL_RGBA, GLES30.GL_FLOAT, GLES30.GL_NEAREST, 4, 4);
