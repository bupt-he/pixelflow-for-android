    ...
    public void onClickButton(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_trees:
                ...
                break;
            case R.id.btn_3d_cloth:
                bundle.putInt(DISPLAY_TAG, 12);

                break;
            case R.id.btn_3d_particle:
                bundle.putInt(DISPLAY_TAG, 13);
                break;
            case R.id.btn_3d_playground:
                bundle.putInt(DISPLAY_TAG, 14);
                break;
        }
