...
public class DwOpticalFlow {
  ...
  public void computeOpticalFlow() {
    ...
    if(UPDATE_STEP >= 1){
      ...
      Merge.TexMad tm0 = new Merge.TexMad(framePrev.velocity,      mix, 0);
      Merge.TexMad tm1 = new Merge.TexMad(frameCurr.velocity, 1f - mix, 0);
  ...
  public static class Frame{
    ...
    public boolean resize(DwPixelFlow context_, int w, int h, boolean grayscale){
      int internalformat = grayscale ? GLES30.GL_R16F : GLES30.GL_RGBA16F;
      int format         = grayscale ? GLES30.GL_RED  : GLES30.GL_RGBA;
      ...
      context.begin();
      boolean resized = false;
      resized |= frame   .resize(context, internalformat, w, h, format     , GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_MIRRORED_REPEAT, channels, 2);
      resized |= sobelH  .resize(context, internalformat, w, h, format     , GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_MIRRORED_REPEAT, channels, 2);
      resized |= sobelV  .resize(context, internalformat, w, h, format     , GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_MIRRORED_REPEAT, channels, 2);
      resized |= velocity.resize(context, GLES30.GL_RG16F  , w, h, GLES30.GL_RG  , GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_MIRRORED_REPEAT, 2       , 2);
      resized |= tmp     .resize(context, GLES30.GL_RGBA16F, w, h, GLES30.GL_RGBA, GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_MIRRORED_REPEAT, 4       , 2);
      context.end();
      return resized;
    }
