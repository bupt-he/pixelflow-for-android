...
public class DwFluid2D{
  ...
  // textures
  public DwGLTexture.TexturePingPong tex_velocity    = new DwGLTexture.TexturePingPong();
  public DwGLTexture.TexturePingPong tex_density     = new DwGLTexture.TexturePingPong();
  public DwGLTexture.TexturePingPong tex_pressure    = new DwGLTexture.TexturePingPong();
  public DwGLTexture.TexturePingPong tex_temperature = new DwGLTexture.TexturePingPong();
  public DwGLTexture.TexturePingPong tex_obstacleC   = new DwGLTexture.TexturePingPong();
  public DwGLTexture.TexturePingPong tex_obstacleN   = new DwGLTexture.TexturePingPong();
  ...
  public DwFluid2D(DwPixelFlow context){
    ...
    shader_obstacleBounds        = context.createShader(DwPixelFlow.SHADER_DIR+"obstacleBounds.frag");
    shader_advect                = context.createShader(DwPixelFlow.SHADER_DIR+"advect.frag"        );
    shader_buoyancy              = context.createShader(DwPixelFlow.SHADER_DIR+"buoyancy.frag"      );
    shader_divergence            = context.createShader(DwPixelFlow.SHADER_DIR+"divergence.frag"    );
    shader_jacobi                = context.createShader(DwPixelFlow.SHADER_DIR+"jacobi.frag"        );
    shader_gradient              = context.createShader(DwPixelFlow.SHADER_DIR+"gradient.frag"      );
    shader_vorticityCurl         = context.createShader(DwPixelFlow.SHADER_DIR+"vorticityCurl.frag" );
    shader_vorticityForce        = context.createShader(DwPixelFlow.SHADER_DIR+"vorticityForce.frag");
    shader_renderFluid           = context.createShader(DwPixelFlow.SHADER_DIR+"renderFluid.frag");
    shader_renderVelocityStreams = context.createShader(DwPixelFlow.SHADER_DIR+"renderVelocityStreams.vert", DwPixelFlow.SHADER_DIR+"renderVelocityStreams.frag");
   
    shader_addVelocityBlob       = context.createShader(DwPixelFlow.SHADER_DIR+"addVelocityBlob.frag"   );
    shader_addDensityBlob        = context.createShader(DwPixelFlow.SHADER_DIR+"addDensityBlob.frag"    );
    shader_addTemperatureBlob    = context.createShader(DwPixelFlow.SHADER_DIR+"addTemperatureBlob.frag");
    shader_addDensityTexture     = context.createShader(DwPixelFlow.SHADER_DIR+"addDensityTexture.frag" );
    shader_addObstacleTexture    = context.createShader(DwPixelFlow.SHADER_DIR+"addObstacleTexture.frag");
  }
  ...
  public boolean resize(int viewport_width, int viewport_height, int fluidgrid_scale) {
    ...
    resized |= tex_velocity   .resize(context, GLES30.GL_RG16F  , fluid_w, fluid_h, GLES30.GL_RG  , GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 2,4);
    resized |= tex_density    .resize(context, GLES30.GL_RGBA16F, fluid_w, fluid_h, GLES30.GL_RGBA, GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 4,4);
    resized |= tex_temperature.resize(context, GLES30.GL_R16F   , fluid_w, fluid_h, GLES30.GL_RED , GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 1,4);
    resized |= tex_curl       .resize(context, GLES30.GL_R16F   , fluid_w, fluid_h, GLES30.GL_RED , GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 1,4);
    resized |= tex_divergence .resize(context, GLES30.GL_R16F   , fluid_w, fluid_h, GLES30.GL_RED , GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 1,4);
    resized |= tex_pressure   .resize(context, GLES30.GL_R16F   , fluid_w, fluid_h, GLES30.GL_RED , GLES30.GL_FLOAT        , GLES30.GL_LINEAR , 1,4);
    resized |= tex_obstacleC  .resize(context, GLES30.GL_R8     , fluid_w, fluid_h, GLES30.GL_RED , GLES30.GL_UNSIGNED_BYTE, GLES30.GL_NEAREST, 1,1);
    resized |= tex_obstacleN  .resize(context, GLES30.GL_RGBA8  , fluid_w, fluid_h, GLES30.GL_RGBA, GLES30.GL_UNSIGNED_BYTE, GLES30.GL_NEAREST, 4,1);
  ...
  private void diffuse(DwGLTexture.TexturePingPong tex, float diffuse){
