...
public class DwShadertoy{
  ...
  public boolean resize(int w, int h){
    boolean resized = tex.resize(context, GLES30.GL_RGBA32F, w, h, GLES30.GL_RGBA, GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_CLAMP_TO_EDGE, 4, 4);
...
//    }
  ...
  static public enum TexFilter{
    NEAREST(GLES30.GL_NEAREST, GLES30.GL_NEAREST),
    LINEAR(GLES30.GL_LINEAR, GLES30.GL_LINEAR),
  ...
  static public enum TexWrap{
    ...
    REPEAT(GLES30.GL_MIRRORED_REPEAT);
