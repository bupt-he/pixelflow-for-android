...
public class DwGLTexture{
  ...
  // some default values
  public final int target     = GLES30.GL_TEXTURE_2D;
  public int internalFormat   = GLES30.GL_RGBA8;
  public int format           = GLES30.GL_RGBA;
  public int type             = GLES30.GL_UNSIGNED_BYTE;
  public int filter           = GLES30.GL_NEAREST;
  public int wrap             = GLES32.GL_CLAMP_TO_BORDER;
...
//    gl.glTexSubImage2D(target, 0, 0, 0, w, h, format, type, data);
    ...
    if(B_FILTER){
      GLES30.glTexParameteri(target, GLES30.GL_TEXTURE_MIN_FILTER, filter); // GL_NEAREST, GL_LINEAR
    ...
    if(B_WRAP){
      ...
      GLES30.glTexParameterfv(target, GLES32.GL_TEXTURE_BORDER_COLOR, new float[]{0,0,0,0}, 0);
    }
  ...
  public void setParamWrap(int wrap){
    this.wrap = wrap;
    gl.glBindTexture  (target, HANDLE[0]);
    gl.glTexParameteri(target, GLES30.GL_TEXTURE_WRAP_S, wrap);
    gl.glTexParameteri(target, GLES30.GL_TEXTURE_WRAP_T, wrap);
    gl.glBindTexture  (target, 0);
  }
  ...
  public void setParamWrap(int wrap, float[] border_color){
    ...
    GLES30.glTexParameteri (target, GLES30.GL_TEXTURE_WRAP_S, wrap);
    GLES30.glTexParameteri (target, GLES30.GL_TEXTURE_WRAP_T, wrap);
    GLES30.glTexParameterfv(target, GLES32.GL_TEXTURE_BORDER_COLOR, border_color, 0);
  ...
  public void setParamBorder(float[] border){
    gl.glBindTexture   (target, HANDLE[0]);
    gl.glTexParameterfv(target, GLES32.GL_TEXTURE_BORDER_COLOR, border, 0);
    gl.glBindTexture   (target, 0);
  }
  @SuppressLint("NewApi")
  public void setParamBorder(int[] border){
    GLES30.glBindTexture    (target, HANDLE[0]);
    GLES32.glTexParameterIiv(target, GLES32.GL_TEXTURE_BORDER_COLOR, border, 0);
    GLES30.glBindTexture    (target, 0);
  }
  ...
  */
  ...
  public static final int   SWIZZLE_R = GLES30.GL_RED;
  public static final int   SWIZZLE_G = GLES30.GL_GREEN;
  public static final int   SWIZZLE_B = GLES30.GL_BLUE;
  public static final int   SWIZZLE_A = GLES30.GL_ALPHA;
  public static final int   SWIZZLE_0 = GLES30.GL_ZERO;
  public static final int   SWIZZLE_1 = GLES30.GL_ONE;
  ...
  public void swizzle(int[] i4_GL_TEXTURE_SWIZZLE_RGBA){
    glTexParameteriv(GLES32.GL_TEXTURE_SWIZZLE_R, i4_GL_TEXTURE_SWIZZLE_RGBA, true);
  }
  ...
  public ByteBuffer getData_GL2ES3(int x, int y, int w, int h){
    ...
    GLES30.glBindBuffer(GLES30.GL_PIXEL_PACK_BUFFER, HANDLE_pbo[0]);
    GLES30.glBufferData(GLES30.GL_PIXEL_PACK_BUFFER, buffer_size, null, GLES30.GL_DYNAMIC_READ);
    GLES30.glReadPixels(x, y, w, h, format, type, 0);
    
    ByteBuffer bbuffer = (ByteBuffer) GLES30.glMapBufferRange(GLES30.GL_PIXEL_PACK_BUFFER, 0, buffer_size, GLES30.GL_MAP_READ_BIT);
//    ByteBuffer bbuffer = gl.glMapBuffer(GL2.GL_PIXEL_PACK_BUFFER, GL2.GL_READ_ONLY);

    GLES32.glUnmapBuffer(GLES30.GL_PIXEL_PACK_BUFFER);
  ...
  public void getData_GL2GL3(Buffer buffer){
    ...
    // TODO: 2023/7/1 需要处理
//    GLES30.glTexImage2D(target, 0, format, type, buffer);
