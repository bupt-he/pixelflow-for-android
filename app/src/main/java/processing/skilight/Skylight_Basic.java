...
import processing.dw.DwBoundingSphere;
import processing.dw.DwPixelFlow;
import processing.dw.DwSceneDisplay;
import processing.dw.DwSkyLight;
import processing.dw.DwVertexRecorder;
...
//    surface.setLocation(viewport_x, viewport_y);
    ...
    shape = loadShape("skylight_demo_scene.obj");

    Log.d("heyibin",shape.toString());
