...
import processing.dw.DwIndexedFaceSetAble;
import processing.dw.DwMeshUtils;
import processing.dw.DwSoftBody;
import processing.dw.DwSpringConstraint;
import processing.dw.DwSpringConstraint3D;
import processing.dw.DwStrokeStyle;
...
//        ifs = new DwCube(1);
  ...
  @Override
  public void displaySprings(PGraphics pg, DwStrokeStyle style, DwSpringConstraint.TYPE type){
