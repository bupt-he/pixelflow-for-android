...
public class DwLiquidFX {
  ...
  protected final int SWIZZLE_R = GLES30.GL_RED;
  protected final int SWIZZLE_G = GLES30.GL_GREEN;
  protected final int SWIZZLE_B = GLES30.GL_BLUE;
  protected final int SWIZZLE_A = GLES30.GL_ALPHA;
  protected final int SWIZZLE_0 = GLES30.GL_ZERO;
  protected final int SWIZZLE_1 = GLES30.GL_ONE;
...
//    tex_particles.resize(context, GL2.GL_RGBA8, w, h, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, GL2.GL_LINEAR, 4, 1);
    tex_particles.resize(context, GLES30.GL_RGBA16F, w, h, GLES30.GL_RGBA, GLES30.GL_FLOAT, GLES30.GL_LINEAR, 4, 2);
//    for(int i = 0; i < 50; i++){
...
//      filter.merge.apply(tex_blur_base, tex_blur_base, tex_edge, mad_A, mad_B);
      ...
      Merge.TexMad tm0 = new Merge.TexMad(tex_blur_base, 1, 0);
      Merge.TexMad tm1 = new Merge.TexMad(tex_edge     , 1, 0);
