...
public class BinomialBlur {
    ...
    public static enum TYPE {
        _3x3(1, "BINOMIAL_3x3"), _5x5(2, "BINOMIAL_5x5"), _7x7(3, "BINOMIAL_7x7"), _9x9(4, "BINOMIAL_9x9"), _11x11(5, "BINOMIAL_11x11"), _13x13(6, "BINOMIAL_13x13"), _15x15(7, "BINOMIAL_15x15");
...
//    int binomial_norm = 1 << (N - 1);
    ...
    public void apply(PGraphicsOpenGL src, PGraphicsOpenGL dst, PGraphicsOpenGL tmp, TYPE kernel) {
        ...
        if (!tex_dst.available()) return;
        Texture tex_tmp = tmp.getTexture();
        if (!tex_tmp.available()) return;
