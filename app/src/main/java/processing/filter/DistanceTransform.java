...
public class DistanceTransform {
  ...
  public void resize(int w, int h){
    ...
    tex_dtnn.resize(context, GLES30.GL_RG16UI, w, h, GLES30.GL_RG_INTEGER, GLES30.GL_UNSIGNED_SHORT, GLES30.GL_NEAREST, GLES30.GL_CLAMP_TO_EDGE, 2, 2);
  ...
  public void computeDistanceField(){
    ...
    tex_dist.resize(context, GLES30.GL_R32F, w, h, GLES30.GL_RED, GLES30.GL_FLOAT, GLES30.GL_LINEAR, GLES30.GL_CLAMP_TO_EDGE, 1, 4);
